<template>
  ...
  <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-2xl max-w-md w-full mx-4">
      <!-- Header -->
        ...
        <div v-if="whatsappStatus.connected" class="text-center">
          ...
          <div class="space-y-3">
            ...
            <button 
              ...
              :disabled="loading"
              class="w-full bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-red-600 dark:text-red-400 font-medium py-2.5 px-4 rounded-lg transition-colors disabled:opacity-50 border border-red-200 dark:border-red-800"
            >
