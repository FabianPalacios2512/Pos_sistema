      ...
      <table class="w-full">
        <thead class="bg-[#f8f9fa] dark:bg-[#1e1f20] border-b border-gray-200 dark:border-zinc-800">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-zinc-400 uppercase tracking-wider">Permisos</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-zinc-400 uppercase tracking-wider">Usuarios</th>
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-zinc-500">{{ role.description || 'Sin descripción' }}</p>
                </div>
              </div>
            </td>
