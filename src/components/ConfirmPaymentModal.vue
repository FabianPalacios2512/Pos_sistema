<template>
  <div class="fixed inset-0 bg-black/70 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-zinc-700 animate-scale-in max-h-[90vh] flex flex-col">
      ...
      <!-- Header Compacto -->
      <div class="bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-700 px-5 py-4 rounded-t-2xl flex-shrink-0">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-zinc-400">Verifique los datos antes de procesar</p>
            </div>
          </div>
      ...
      <div class="p-4 bg-gray-50 dark:bg-zinc-800 border-t border-gray-200 dark:border-zinc-700 rounded-b-2xl flex-shrink-0">
        <div class="flex gap-2">
          <button
            @click="$emit('close')"
            class="flex-1 px-4 py-2.5 bg-white dark:bg-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-600 text-gray-700 dark:text-zinc-200 border border-gray-300 dark:border-zinc-600 text-sm font-semibold rounded-xl transition-all hover:shadow-md"
          >
            Cancelar
          </button>
          <button
            ...
            :disabled="processing"
            class="flex-1 px-4 py-2.5 bg-gradient-to-r from-lime-400 to-green-400 hover:from-lime-500 hover:to-green-500 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white text-sm font-bold rounded-xl shadow-md transition-all disabled:hover:shadow-md hover:shadow-lg flex items-center justify-center gap-2"
          >
