  ...
  <div class="min-h-screen font-sans bg-gradient-to-br from-gray-50 via-white to-slate-100 dark:bg-gradient-to-b dark:from-[#141417] dark:via-slate-900 dark:to-[#0a0a0c] transition-colors duration-300 px-8">
    <div class="p-4 lg:p-6 space-y-6 pb-8 animate-fade-in">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-gray-300 dark:border dark:border-white/5 hover:border-gray-400 dark:hover:border-white/10 transition-all duration-200 shadow-md hover:shadow-lg dark:shadow-lg dark:shadow-black/50">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Total Categorías</p>
              <p class="text-2xl font-bold text-gray-900 dark:text-white mt-0.5">{{ totalCategories }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-gray-300 dark:border dark:border-white/5 hover:border-gray-400 dark:hover:border-white/10 transition-all duration-200 shadow-md hover:shadow-lg dark:shadow-lg dark:shadow-black/50">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Productos Total</p>
        ...
        <!-- Más Popular -->
        <div class="bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-gray-300 dark:border dark:border-white/5 hover:border-grayrua-400 dark:hover:border-white/10 transition-all duration-200 shadow-md hover:shadow-lg dark:shadow-lg dark:shadow-black/50">
          <div class="flex items-center gap-3">
            <div class="w-11 h-11 bg-gray-100 dark:bg-zinc-800/50 border border-gray-200 dark:border-white/5 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Más Popular</p>
              <p class="text-2xl font-bold text-gray-900 dark:text-white mt-0.5 truncate">{{ mostPopularCategory?.name || 'N/A' }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-gray-300 dark:border dark:border-white/5 hover:border-gray-400 dark:hover:border-white/10 transition-all duration-200 shadow-md hover:shadow-lg dark:shadow-lg dark:shadow-black/50">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Con Productos</p>
              <p class="text-2xl font-bold text-gray-900 dark:text-white mt-0.5">{{ categoriesWithProducts }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-black/50 border border-gray-300 dark:border-zinc-800 overflow-hidden mb-8">
        ...
        <div class="p-4 border-b border-gray-200 dark:border-zinc-800">
          ...
          <select
            ...
            class="px-3 py-3 text-sm rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-700 dark:text-zinc-300 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors duration-300 min-w-36">
          ...
          <!-- Toggle Vista -->
          <div class="flex items-center bg-gray-50 dark:bg-zinc-800 rounded-xl p-1 border border-gray-200 dark:border-zinc-700 h-[46px]">
            <button
              @click="setViewMode('grid')"
              :class="[
                'flex items-center justify-center px-4 h-full rounded-lg transition-all text-xs font-bold',
                viewMode === 'grid' 
          ...
          <button
            @click="clearFilters"
            class="p-3 text-gray-500 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors border border-transparent hover:border-red-100 dark:hover:border-red-900/30"
      ...
      <div v-if="viewMode === 'grid'">
        <!-- Sin resultados -->
        <div v-if="paginatedCategories.length === 0" class="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-300 dark:border-zinc-800 p-12 text-center">
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 p-6">
          <div
            ...
            :class="[
              'bg-white dark:bg-zinc-900 rounded-xl border border-gray-300 dark:border-zinc-800 hover:border-blue-300 dark:hover:border-blue-700 shadow-md hover:shadow-lg dark:shadow-lg dark:shadow-black/50 transition-all duration-300 overflow-hidden group flex flex-col cursor-pointer',
              !category.active && 'opacity-75'
            ]">
            
            <!-- Header -->
            <div class="bg-gray-50 dark:bg-zinc-800/50 border-b border-gray-200 dark:border-zinc-800 p-4">
              <div class="flex items-center space-x-3 mb-2">
                ...
                <div class="flex-1 min-w-0">
                  <h3 class="text-sm font-bold text-gray-900 dark:text-white truncate">{{ category.name }}</h3>
                  <span
              ...
              <p class="text-xs text-gray-600 dark:text-zinc-400 line-clamp-2">{{ category.description }}</p>
            </div>
            ...
            <div class="p-4 flex-1 flex flex-col">
              ...
              <div class="grid grid-cols-2 gap-3 mb-4 flex-1">
                <div class="text-center bg-gray-50 dark:bg-zinc-800 rounded-xl p-3 border border-gray-100 dark:border-zinc-700">
                  <div class="text-lg font-black text-gray-900 dark:text-white">{{ category.products_count || 0 }}</div>
                  <div class="text-[10px] text-gray-500 dark:text-zinc-400 font-medium uppercase tracking-wide">Productos</div>
                </div>
                <div class="text-center bg-emerald-50 dark:bg-emerald-950/30 rounded-xl p-3 border border-emerald-100 dark:border-emerald-900/50">
                  <div class="text-lg font-black text-emerald-700 dark:text-emerald-400">${{ formatCurrency(category.revenue || 0) }}</div>
                  <div class="text-[10px] text-gray-500 dark:text-zinc-400 font-medium uppercase tracking-wide">Ventas</div>
                </div>
              </div>

              <!-- Estado y fecha -->
              <div class="flex justify-between items-center text-xs text-gray-500 dark:text-zinc-500 mb-4 pb-3 border-t border-gray-100 dark:border-zinc-800 pt-3">
              ...
              <div class="grid grid-cols-3 gap-2">
                <button
                  ...
                  class="flex items-center justify-center py-2 rounded-lg text-slate-400 dark:text-zinc-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all border border-transparent hover:border-blue-100 dark:hover:border-blue-900/30"
                  title="Ver Productos">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  class="flex items-center justify-center py-2 rounded-lg text-slate-400 dark:text-zinc-500 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all border border-transparent hover:border-amber-100 dark:hover:border-amber-900/30"
                  title="Editar">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div v-else>
        ...
        <div class="bg-gray-50 dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 px-6 py-4 flex items-center justify-between">
          <div>
            <h2 class="text-base font-bold text-gray-900 dark:text-white">Lista de Categorías</h2>
            <p class="text-xs text-gray-600 dark:text-zinc-400 mt-0.5">{{ totalCategories }} categorías en total</p>
          </div>
        </div>
      ...
      <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-800">
        <thead class="bg-gray-50 dark:bg-zinc-900">
          <tr>
            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wide">
              Categoría
            </th>
            <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wide">
              Productos
            </th>
            <th class="px-6 py-4 text-right text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wide">
              Ventas
            </th>
            <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wide">
              Estado
        ...
        <tbody class="bg-white dark:bg-zinc-900 divide-y divide-gray-200 dark:divide-zinc-800">
          <tr
            ...
            :key="category.id"
            @click="viewCategoryProducts(category)"
            :class="['hover:bg-slate-50 dark:hover:bg-zinc-800/50 hover:shadow-sm transition-colors cursor-pointer', !category.active && 'opacity-75']">
            <td class="px-6 py-4">
              <div class="flex items-center space-x-3">
                <!-- Icono de la categoría -->
                <div 
                ...
                <div>
                  ...
                  <div class="text-xs text-gray-500 dark:text-zinc-400 line-clamp-1">{{ category.description }}</div>
                </div>
              </div>
            </td>
            <td class="px-6 py-4 text-center">
              <span class="text-base font-black text-gray-900 dark:text-white">{{ category.products_count || 0 }}</span>
            </td>
            <td class="px-6 py-4 text-right">
              <span class="text-base font-black text-gray-900 dark:text-white">${{ formatCurrency(category.revenue || 0) }}</span>
            </td>
            <td class="px-6 py-4 text-center">
              <span
                :class="[
            ...
            <td class="px-6 py-4">
              <span class="text-sm text-gray-600 dark:text-zinc-400">{{ formatDate(category.created_at) }}</span>
            </td>
            <td class="px-6 py-4">
              <div class="flex items-center justify-center gap-2">
                ...
                <button
                  @click.stop="editCategory(category)"
                  class="p-2.5 text-gray-400 dark:text-zinc-500 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-all"
                  title="Editar">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                  </svg>
                ...
                <button
                  ...
                  :class="category.active 
                    ? 'text-gray-400 dark:text-zinc-500 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/20' 
                    : 'text-gray-400 dark:text-zinc-500 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20'"
                  :title="category.active ? 'Desactivar' : 'Activar'">
                  <svg v-if="category.active" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
      ...
      <div v-if="filteredCategories.length > 10" class="border-t border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900">
        <TablePaginator
          ...
          <div>
            ...
            <div class="grid grid-cols-6 gap-2 max-h-48 overflow-y-auto p-2 border border-gray-200 rounded-lg bg-gray-50">
              <button
                ...
                :class="[
                  'p-2 rounded-xl border-2 transition-all duration-200 hover:scale-110',
