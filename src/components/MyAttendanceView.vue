        ...
        <div class="relative bg-white dark:bg-zinc-900 rounded-md max-w-lg w-full border border-gray-200 dark:border-zinc-800 shadow-2xl overflow-hidden">
          ...
          <div class="px-6 py-4 border-t border-gray-200 dark:border-zinc-800 flex items-center justify-end gap-3">
            ...
            <button @click="goToPos"
              class="px-5 py-2.5 text-sm font-bold text-white bg-gray-900 dark:bg-zinc-700 hover:bg-black dark:hover:bg-gray-600 rounded-md transition-colors flex items-center gap-2">
                ...
                <div v-else class="flex-1 flex flex-col">
                  ...
                  <div class="mt-auto">
                    <button
                      ...
                      :disabled="recording"
                      class="w-full py-3 rounded-md bg-gray-900 dark:bg-white text-white dark:text-zinc-900 font-semibold text-sm transition-colors hover:bg-black dark:hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
