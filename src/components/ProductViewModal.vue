<!--
 ...
 Para usar este modal, asegurate de:
 1. Verificar que estás en el contexto del POS
 2. Pasar la prop 'product' con los datos del producto
 3. Emitir 'close' para cerrar el modal
 4. Emitir 'edit' cuando se clickea el botón editar
-->
<template>
