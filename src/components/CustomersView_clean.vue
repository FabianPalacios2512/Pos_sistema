            ...
            >
              ...
              <div class="flex items-center gap-3">
                ...
                <div 
                  ...
                  :class="{ 'cursor-pointer hover:scale-110 hover:ring-2 hover:ring-indigo-400': customer.credit_photo }"
              ...
              <div class="flex items-start justify-between">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div 
                    ...
                    :class="{ 'cursor-pointer hover:scale-105 hover:ring-2 hover:ring-indigo-400': selectedCustomer.credit_photo }"
              ...
              <div class="flex items-center gap-6">
                ...
                <div class="flex flex-col gap-2">
                  <button type="button"
                          ...
                          class="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div v-if="showPhotoPreviewModal" @click="closePhotoPreview" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 ">
        ...
        >
          <div v-if="showPhotoPreviewModal" @click.stop class="relative max-w-4xl w-full">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-t-2xl px-6 py-4 border-b border-gray-200 dark:border-zinc-800">
              <div>
