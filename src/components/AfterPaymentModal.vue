    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-sm w-full border border-gray-200 dark:border-zinc-700 animate-scale-in">
      ...
      <div class="p-5">
        ...
        <div class="space-y-3">
          ...
          <button
            @click="printInvoice"
            class="w-full flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm rounded-xl transition-colors duration-200 shadow-md font-bold"
          >
          ...
          <button
            @click="sendWhatsApp"
            class="w-full flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white text-sm rounded-xl transition-colors duration-200 shadow-md font-bold"
          >
          ...
          <button
            @click="sendEmail"
            class="w-full flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white text-sm rounded-xl transition-colors duration-200 shadow-md font-bold"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
          ...
          <button
            @click="viewInvoice"
            class="w-full flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-slate-600 to-gray-600 hover:from-slate-700 hover:to-gray-700 text-white text-sm rounded-xl transition-colors duration-200 shadow-md font-bold"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <button
          @click="newSale"
          class="w-full flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white text-sm rounded-xl transition-colors duration-200 shadow-md font-bold"
        >
...
const props = defineProps({
  ...
  userPlan: { type: String, default: 'free_trial' } // Plan del usuario: free_trial, free, basic, premium, enterprise
})

// Emits
const emit = defineEmits(['close', 'print-invoice', 'send-whatsapp', 'send-email', 'view-invoice', 'new-sale'])
