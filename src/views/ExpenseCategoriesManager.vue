        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-3">
            ...
            <button
              ...
              class="px-4 py-2 bg-slate-900 dark:bg-slate-700 hover:bg-black dark:hover:bg-slate-600 text-white rounded-xl font-medium transition-all duration-200 flex items-center space-x-2 shadow-lg shadow-slate-400/40 dark:shadow-slate-900/50"
            >
      ...
      <div class="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] flex flex-col">
        ...
        <div class="sticky bottom-0 bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-2xl flex justify-end space-x-3">
          ...
          <button
            ...
            class="px-4 py-2 bg-slate-900 dark:bg-slate-700 hover:bg-black dark:hover:bg-slate-600 text-white rounded-xl font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
          >
