...
function getHourlyEfficiency() {
    try {
        ...
        if ($period === 'today') {
            ...
            // NOTA: created_at ya está guardado en timezone America/Bogota, NO necesita conversión
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'hourly_data_filtered' => array_values(array_filter($fullDayData, function($data) { return $data['sales'] > 0; })), // Solo horas con actividad, reindexado desde 0
                'peak_hour' => $peakHour,
